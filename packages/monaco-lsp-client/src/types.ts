...
import { contract, unverifiedRequest, unverifiedNotification } from "@hediet/json-rpc";
...
export type NotebookDocumentFilter =
  | { notebookType: string; scheme?: string; pattern?: string }
  | { notebookType?: string; scheme: string; pattern?: string }
  | { notebookType?: string; scheme?: string; pattern: string };
...
export interface DocumentColorRegistrationOptions
  extends TextDocumentRegistrationOptions, DocumentColorOptions, StaticRegistrationOptions {}
...
export interface InlineCompletionRegistrationOptions
  extends InlineCompletionOptions, TextDocumentRegistrationOptions, StaticRegistrationOptions {}
 ...
 */
export type WorkspaceSymbolRegistrationOptions = WorkspaceSymbolOptions;
 ...
 */
export type ExecuteCommandRegistrationOptions = ExecuteCommandOptions;
...
export interface NotebookDocumentSyncOptions {
   ...
   */
  notebookSelector: (
    | { notebook: string | NotebookDocumentFilter; cells?: { language: string }[] }
    | { notebook?: string | NotebookDocumentFilter; cells: { language: string }[] }
  )[];
  /**
...
export interface GeneralClientCapabilities {
   ...
   * @since 3.17.0
   */
  staleRequestSupport?: { cancel: boolean; retryOnContentModified: string[] };
  /**
...
export interface SemanticTokensClientCapabilities {
   ...
   */
  requests: { range?: boolean | Record<string, never>; full?: boolean | { delta?: boolean } };
  /**
 ...
 *
 * `__options` is a phantom marker field that makes `T` load-bearing at the type
 * level — without it, `T` is unused and TypeScript treats all `Capability<X>` as
 * structurally identical, defeating closed-set enforcement via union upper bounds
 * like `Capability<A> | Capability<B>`. `declare readonly` emits no runtime code.
 */
export class Capability<T> {
  declare readonly __options: T;
...
export const capabilities = {
  textDocumentImplementation: new Capability<ImplementationRegistrationOptions>(
    "textDocument/implementation",
  ),
  textDocumentTypeDefinition: new Capability<TypeDefinitionRegistrationOptions>(
    "textDocument/typeDefinition",
  ),
  textDocumentDocumentColor: new Capability<DocumentColorRegistrationOptions>(
    "textDocument/documentColor",
  ),
  textDocumentColorPresentation: new Capability<
    WorkDoneProgressOptions & TextDocumentRegistrationOptions
  >("textDocument/colorPresentation"),
  textDocumentFoldingRange: new Capability<FoldingRangeRegistrationOptions>(
    "textDocument/foldingRange",
  ),
  textDocumentDeclaration: new Capability<DeclarationRegistrationOptions>(
    "textDocument/declaration",
  ),
  textDocumentSelectionRange: new Capability<SelectionRangeRegistrationOptions>(
    "textDocument/selectionRange",
  ),
  textDocumentPrepareCallHierarchy: new Capability<CallHierarchyRegistrationOptions>(
    "textDocument/prepareCallHierarchy",
  ),
  textDocumentSemanticTokensFull: new Capability<SemanticTokensRegistrationOptions>(
    "textDocument/semanticTokens/full",
  ),
  textDocumentSemanticTokensFullDelta: new Capability<SemanticTokensRegistrationOptions>(
    "textDocument/semanticTokens/full/delta",
  ),
  textDocumentLinkedEditingRange: new Capability<LinkedEditingRangeRegistrationOptions>(
    "textDocument/linkedEditingRange",
  ),
  workspaceWillCreateFiles: new Capability<FileOperationRegistrationOptions>(
    "workspace/willCreateFiles",
  ),
  workspaceWillRenameFiles: new Capability<FileOperationRegistrationOptions>(
    "workspace/willRenameFiles",
  ),
  workspaceWillDeleteFiles: new Capability<FileOperationRegistrationOptions>(
    "workspace/willDeleteFiles",
  ),
  textDocumentMoniker: new Capability<MonikerRegistrationOptions>("textDocument/moniker"),
  textDocumentPrepareTypeHierarchy: new Capability<TypeHierarchyRegistrationOptions>(
    "textDocument/prepareTypeHierarchy",
  ),
  textDocumentInlineValue: new Capability<InlineValueRegistrationOptions>(
  ...
  textDocumentInlineCompletion: new Capability<InlineCompletionRegistrationOptions>(
    "textDocument/inlineCompletion",
  ),
  textDocumentWillSaveWaitUntil: new Capability<TextDocumentRegistrationOptions>(
  ...
  textDocumentSignatureHelp: new Capability<SignatureHelpRegistrationOptions>(
  ...
  textDocumentDocumentHighlight: new Capability<DocumentHighlightRegistrationOptions>(
    "textDocument/documentHighlight",
  ),
  textDocumentDocumentSymbol: new Capability<DocumentSymbolRegistrationOptions>(
  ...
  textDocumentDocumentLink: new Capability<DocumentLinkRegistrationOptions>(
    "textDocument/documentLink",
  ),
  textDocumentFormatting: new Capability<DocumentFormattingRegistrationOptions>(
    "textDocument/formatting",
  ),
  textDocumentRangeFormatting: new Capability<DocumentRangeFormattingRegistrationOptions>(
    "textDocument/rangeFormatting",
  ),
  textDocumentRangesFormatting: new Capability<DocumentRangeFormattingRegistrationOptions>(
    "textDocument/rangesFormatting",
  ),
  textDocumentOnTypeFormatting: new Capability<DocumentOnTypeFormattingRegistrationOptions>(
    "textDocument/onTypeFormatting",
  ),
  textDocumentRename: new Capability<RenameRegistrationOptions>("textDocument/rename"),
  workspaceExecuteCommand: new Capability<ExecuteCommandRegistrationOptions>(
    "workspace/executeCommand",
  ),
  workspaceDidCreateFiles: new Capability<FileOperationRegistrationOptions>(
    "workspace/didCreateFiles",
  ),
  workspaceDidRenameFiles: new Capability<FileOperationRegistrationOptions>(
    "workspace/didRenameFiles",
  ),
  workspaceDidDeleteFiles: new Capability<FileOperationRegistrationOptions>(
    "workspace/didDeleteFiles",
  ),
  workspaceDidChangeConfiguration: new Capability<DidChangeConfigurationRegistrationOptions>(
    "workspace/didChangeConfiguration",
  ),
  textDocumentDidOpen: new Capability<TextDocumentRegistrationOptions>("textDocument/didOpen"),
  textDocumentDidChange: new Capability<TextDocumentChangeRegistrationOptions>(
  ...
  workspaceDidChangeWatchedFiles: new Capability<DidChangeWatchedFilesRegistrationOptions>(
...
export const api = contract({
  ...
  server: {
     ...
     */
    textDocumentImplementation: unverifiedRequest<
     ...
     * the response is of type {@link Definition} or a Thenable that resolves to such.
     */
    textDocumentTypeDefinition: unverifiedRequest<
     ...
     */
    textDocumentDocumentColor: unverifiedRequest<DocumentColorParams, ColorInformation[]>({
     ...
     * that resolves to such.
     */
    textDocumentColorPresentation: unverifiedRequest<ColorPresentationParams, ColorPresentation[]>({
     ...
     * that resolves to such.
     */
    textDocumentFoldingRange: unverifiedRequest<FoldingRangeParams, FoldingRange[] | null>({
     ...
     */
    textDocumentDeclaration: unverifiedRequest<
      DeclarationParams,
     ...
     * that resolves to such.
     */
    textDocumentSelectionRange: unverifiedRequest<SelectionRangeParams, SelectionRange[] | null>({
     ...
     * @since 3.16.0
     */
    textDocumentPrepareCallHierarchy: unverifiedRequest<
     ...
     * @since 3.16.0
     */
    callHierarchyIncomingCalls: unverifiedRequest<
     ...
     * @since 3.16.0
     */
    callHierarchyOutgoingCalls: unverifiedRequest<
     ...
     * @since 3.16.0
     */
    textDocumentSemanticTokensFull: unverifiedRequest<SemanticTokensParams, SemanticTokens | null>({
      method: "textDocument/semanticTokens/full",
    }),
    /**
     * @since 3.16.0
     */
    textDocumentSemanticTokensFullDelta: unverifiedRequest<
     ...
     * @since 3.16.0
     */
    textDocumentSemanticTokensRange: unverifiedRequest<
     ...
     * @since 3.16.0
     */
    textDocumentLinkedEditingRange: unverifiedRequest<
     ...
     * @since 3.16.0
     */
    workspaceWillCreateFiles: unverifiedRequest<CreateFilesParams, WorkspaceEdit | null>({
     ...
     * @since 3.16.0
     */
    workspaceWillRenameFiles: unverifiedRequest<RenameFilesParams, WorkspaceEdit | null>({
     ...
     * @since 3.16.0
     */
    workspaceWillDeleteFiles: unverifiedRequest<DeleteFilesParams, WorkspaceEdit | null>({
     ...
     */
    textDocumentMoniker: unverifiedRequest<MonikerParams, Moniker[] | null>({
     ...
     * @since 3.17.0
     */
    textDocumentPrepareTypeHierarchy: unverifiedRequest<
     ...
     * @since 3.17.0
     */
    typeHierarchySupertypes: unverifiedRequest<
     ...
     * @since 3.17.0
     */
    typeHierarchySubtypes: unverifiedRequest<
     ...
     * @since 3.17.0
     */
    textDocumentInlineValue: unverifiedRequest<InlineValueParams, InlineValue[] | null>({
     ...
     * @since 3.17.0
     */
    textDocumentInlayHint: unverifiedRequest<InlayHintParams, InlayHint[] | null>({
     ...
     * @since 3.17.0
     */
    textDocumentDiagnostic: unverifiedRequest<DocumentDiagnosticParams, DocumentDiagnosticReport>({
     ...
     * @since 3.17.0
     */
    workspaceDiagnostic: unverifiedRequest<WorkspaceDiagnosticParams, WorkspaceDiagnosticReport>({
     ...
     * @proposed
     */
    textDocumentInlineCompletion: unverifiedRequest<
     ...
     * reliable.
     */
    textDocumentWillSaveWaitUntil: unverifiedRequest<WillSaveTextDocumentParams, TextEdit[] | null>(
     ...
     */
    textDocumentCompletion: unverifiedRequest<
      CompletionParams,
     ...
     */
    completionItemResolve: unverifiedRequest<CompletionItem, CompletionItem>({
     ...
     */
    textDocumentHover: unverifiedRequest<HoverParams, Hover | null>({
      method: "textDocument/hover",
    }),
    textDocumentSignatureHelp: unverifiedRequest<SignatureHelpParams, SignatureHelp | null>({
     ...
     */
    textDocumentDefinition: unverifiedRequest<
      DefinitionParams,
      Definition | DefinitionLink[] | null
     ...
     */
    textDocumentReferences: unverifiedRequest<ReferenceParams, Location[] | null>({
     ...
     * or a Thenable that resolves to such.
     */
    textDocumentDocumentHighlight: unverifiedRequest<
     ...
     * that resolves to such.
     */
    textDocumentDocumentSymbol: unverifiedRequest<
     ...
     */
    textDocumentCodeAction: unverifiedRequest<CodeActionParams, (Command | CodeAction)[] | null>({
     ...
     *
     */
    workspaceSymbol: unverifiedRequest<
     ...
     * @since 3.17.0
     */
    workspaceSymbolResolve: unverifiedRequest<WorkspaceSymbol, WorkspaceSymbol>({
      method: "workspaceSymbol/resolve",
    }),
    /**
     * A request to provide code lens for the given text document.
     */
    textDocumentCodeLens: unverifiedRequest<CodeLensParams, CodeLens[] | null>({
     ...
     */
    textDocumentDocumentLink: unverifiedRequest<DocumentLinkParams, DocumentLink[] | null>({
     ...
     */
    documentLinkResolve: unverifiedRequest<DocumentLink, DocumentLink>({
      method: "documentLink/resolve",
    }),
    /**
     * A request to format a whole document.
     */
    textDocumentFormatting: unverifiedRequest<DocumentFormattingParams, TextEdit[] | null>({
      method: "textDocument/formatting",
    }),
    /**
     * A request to format a range in a document.
     */
    textDocumentRangeFormatting: unverifiedRequest<
     ...
     * @proposed
     */
    textDocumentRangesFormatting: unverifiedRequest<
     ...
     */
    textDocumentOnTypeFormatting: unverifiedRequest<
     ...
     */
    textDocumentRename: unverifiedRequest<RenameParams, WorkspaceEdit | null>({
     ...
     */
    textDocumentPrepareRename: unverifiedRequest<PrepareRenameParams, PrepareRenameResult | null>({
     ...
     */
    workspaceExecuteCommand: unverifiedRequest<ExecuteCommandParams, LSPAny | null>({
     ...
     */
    workspaceDidChangeWorkspaceFolders: unverifiedNotification<DidChangeWorkspaceFoldersParams>({
     ...
     */
    windowWorkDoneProgressCancel: unverifiedNotification<WorkDoneProgressCancelParams>({
     ...
     * @since 3.16.0
     */
    workspaceDidCreateFiles: unverifiedNotification<CreateFilesParams>({
     ...
     * @since 3.16.0
     */
    workspaceDidRenameFiles: unverifiedNotification<RenameFilesParams>({
     ...
     * @since 3.16.0
     */
    workspaceDidDeleteFiles: unverifiedNotification<DeleteFilesParams>({
     ...
     * @since 3.17.0
     */
    notebookDocumentDidOpen: unverifiedNotification<DidOpenNotebookDocumentParams>({
      method: "notebookDocument/didOpen",
    }),
    notebookDocumentDidChange: unverifiedNotification<DidChangeNotebookDocumentParams>({
     ...
     * @since 3.17.0
     */
    notebookDocumentDidSave: unverifiedNotification<DidSaveNotebookDocumentParams>({
     ...
     * @since 3.17.0
     */
    notebookDocumentDidClose: unverifiedNotification<DidCloseNotebookDocumentParams>({
     ...
     */
    workspaceDidChangeConfiguration: unverifiedNotification<DidChangeConfigurationParams>({
     ...
     * is one.
     */
    textDocumentDidOpen: unverifiedNotification<DidOpenTextDocumentParams>({
     ...
     */
    textDocumentDidChange: unverifiedNotification<DidChangeTextDocumentParams>({
     ...
     */
    textDocumentDidClose: unverifiedNotification<DidCloseTextDocumentParams>({
     ...
     */
    textDocumentDidSave: unverifiedNotification<DidSaveTextDocumentParams>({
     ...
     */
    textDocumentWillSave: unverifiedNotification<WillSaveTextDocumentParams>({
     ...
     */
    workspaceDidChangeWatchedFiles: unverifiedNotification<DidChangeWatchedFilesParams>({
  ...
  client: {
     ...
     */
    workspaceWorkspaceFolders: unverifiedRequest<void, WorkspaceFolder[] | null>({
     ...
     */
    workspaceConfiguration: unverifiedRequest<ConfigurationParams, LSPAny[]>({
     ...
     * @proposed
     */
    workspaceFoldingRangeRefresh: unverifiedRequest<void, null>({
     ...
     */
    windowWorkDoneProgressCreate: unverifiedRequest<WorkDoneProgressCreateParams, null>({
      method: "window/workDoneProgress/create",
    }).optional(),
    /**
     * @since 3.16.0
     */
    workspaceSemanticTokensRefresh: unverifiedRequest<void, null>({
     ...
     * @since 3.16.0
     */
    windowShowDocument: unverifiedRequest<ShowDocumentParams, ShowDocumentResult>({
      method: "window/showDocument",
    }).optional(),
    /**
     * @since 3.17.0
     */
    workspaceInlineValueRefresh: unverifiedRequest<void, null>({
      method: "workspace/inlineValue/refresh",
    }).optional(),
    /**
     * @since 3.17.0
     */
    workspaceInlayHintRefresh: unverifiedRequest<void, null>({
     ...
     * @since 3.17.0
     */
    workspaceDiagnosticRefresh: unverifiedRequest<void, null>({
     ...
     */
    clientRegisterCapability: unverifiedRequest<RegistrationParams, null>({
     ...
     * handler on the client side.
     */
    clientUnregisterCapability: unverifiedRequest<UnregistrationParams, null>({
     ...
     */
    windowShowMessageRequest: unverifiedRequest<ShowMessageRequestParams, MessageActionItem | null>(
     ...
     * @since 3.16.0
     */
    workspaceCodeLensRefresh: unverifiedRequest<void, null>({
      method: "workspace/codeLens/refresh",
    }).optional(),
    /**
     * A request sent from the server to the client to modified certain resources.
     */
    workspaceApplyEdit: unverifiedRequest<ApplyWorkspaceEditParams, ApplyWorkspaceEditResult>({
     ...
     */
    textDocumentPublishDiagnostics: unverifiedNotification<PublishDiagnosticsParams>({
